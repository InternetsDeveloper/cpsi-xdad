<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="TelerikWebApp3.ResetPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--==== INTRO ====-->
        <div class="section site-section site-section-light site-section-top themed-background-dark">
            <div class="container">
                <h1 class="text-center animation-slideDown label-intro"><i class="fa fa-group"></i> Student - Reset Password</h1>
                <h5 class="h5 text-center animation-slideUp">In order to reset your password search for student and fill out the password information per the requirements, <br />or use the CANCEL button to back out safely if you are here by mistake.</h5>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 col-lg-8 col-lg-offset-2 site-block">
                        ...
                        <!--==== SEARCH FOR STUDENT ====-->
                        <form action="ResetPassword.aspx" method="post" id="form-stud-reset-pwd" class="form-horizontal">
                            <h4 class="underline-heading">Search for Student</h4>
                                <small>Student Network ID: </small>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="input-group">
                                            <span class="input-group-addon color-i"><i class="fa fa-id-card"></i></span>
                                             <asp:TextBox type="text" id="txtNetworkID" name="txtNetworkID" class="form-control input-lg" runat="server" placeholder="Student Network ID"> </asp:TextBox>
                                        </div>
                                         <div>
                                ...
                                <small>or Student Local ID: </small>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="input-group" style="margin-bottom: 2rem;">
                                            <span class="input-group-addon color-i"><i class="fa fa-id-card"></i></span>
                                            <asp:TextBox type="text" id="txtLocalID" name="txtLocalID" class="form-control input-lg" runat="server" placeholder="Student Local ID"></asp:TextBox>
                                        </div>
                                         <div>
                            ...
                            <div class="form-group form-actions buttons-row">
                                ...
                                <div class="col-xs-6 text-right">
                                    <asp:button type="submit" text="Search" ID="btnSearch" class="btn btn-sm btn-success" runat="server" onclick="btnSearch_Click" />
                                </div>
                            </div>
                            <!--==== /end buttons row ====-->
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox type="text" id="txtStudentName" name="txtStudentName" class="form-control input-lg" ReadOnly="true" runat="server" placeholder="Student Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group form-actions">
                                ...
                                <div class="col-xs-6 text-right buttons-row" style="margin-bottom: 1.5rem;">
   ...
   <%--
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-12 lb-lg">
                Reset a Password for a Student 
        ...
        <div class="form-group">
            <div class="col-sm-12 lb-md">
                Enter the information below to reset the password for a specific student.
            </div>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group" style="margin-bottom: 0.1%">
            <label for="inputType" class="col-sm-2 control-label lb-sm text-nowrap">*Student Username:</label>
            <div class="col-sm-2">
        ...
        <div class="form-group" style="margin-bottom: 0.1%">
         ...
         <div class="form-group">
            <label for="inputType" class="col-sm-2 control-label lb-sm text-nowrap">*Student Local ID:</label>
            <div class="col-sm-2">
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="col-sm-2 lb-sm">
                <asp:Button ID="btnSearch" CssClass="flat-button-two BackGroundColor" runat="server" Text="Find Student" OnClick="btnSearch_Click" />
            </div>
    ...
    <div class="DivBorder">
        <div class="form-horizontal Text-NoWrap">
            <div class="form-group" style="margin-bottom: 0.2%">
                <label for="inputType" class="col-sm-2 control-label lb-sm text-nowrap">Student Name:</label>
                <div class="col-sm-2">
