...
{
    public partial class ResetYourUserName : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
               ...
               // xdADSelfService.SetAttributeValue("Type", "secretqa");
                ...
                else { string userName = retXml.Descendants("sAMAccountName").ElementAt(0).Value;Session["userName"] = userName;Response.Redirect("UserName.aspx"); }
            }
