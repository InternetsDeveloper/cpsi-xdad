<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageQuestions.aspx.cs" Inherits="TelerikWebApp3.ManageQuestions" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-12 lb-lg">
                Manage Global Security Questions
                <div class="HorizontalFull"></div>
            </div>

        </div>
        <div class="lb-sm" style="margin-top: 10px">
            On this screen you will need to setup the list of available Security Questions that users will see when they setup their Security Questions.
        </div>
