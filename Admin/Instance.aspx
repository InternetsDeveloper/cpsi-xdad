<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="Instance.aspx.cs" Inherits="TelerikWebApp3.Instance" %>
   ...
   <br />
        ...
        <div class="col-sm-3">
         ...
         <div class="col-sm-7">
            <div class="pull-right-center">
                <div class=" lb-lg">
             Manage Instance Configuration Options
    ...
    <div class="row">
        ...
        <div class="col-sm-3" id="Tile_ResetPasswordForStudent" runat="server">
            <div>
                <telerik:RadContentTemplateTile  CssClass="metro-tile"    ID="btnLogo" AutoPostBack="true" OnClick="btnPolicy_Click" runat="server" Name="firstContentTemplateTile" Shape="Wide">
                    <ContentTemplate>
                        <div class="TileText lb-lg">
                            Manage<br /> Acceptable Use Policy
         ...
         <div class="col-sm-3" id="Tile_ResetPasswordForParent" runat="server">
            <div>
                ...
                <telerik:RadContentTemplateTile  CssClass="metro-tile"    ID="btnPolicy" AutoPostBack="true" OnClick="btnInstance_Click" runat="server" Name="firstContentTemplateTile" Shape="Wide">
                    <ContentTemplate>
                        <div class="TileText lb-lg">
                            Manage<br /> Instance Configuration
                        </div>
                    </ContentTemplate>
                </telerik:RadContentTemplateTile>
            </div>
