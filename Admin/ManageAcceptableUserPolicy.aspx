<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageAcceptableUserPolicy.aspx.cs" Inherits="TelerikWebApp3.ManageAcceptableUserPolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <br />
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-sm-offset-3" id="Tile_ChangeMyQuestions" runat="server">
            <div>
